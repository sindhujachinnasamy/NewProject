...
public class Repor {
	...
	public static String testCaseName, testDescription, excelName, author, category, moduleName;
	...
	//@BeforeMethod
	public ExtentTest startTestIteration( String author, String category,String moduleName) {	
